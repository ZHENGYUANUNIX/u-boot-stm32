 ...
 */
#define CONFIG_STM32_USART_PORT	1		/* USART6 */

#define CONFIG_STM32_USART_TX_IO_PORT	0	/* PORTC */
#define CONFIG_STM32_USART_TX_IO_PIN	9	/* GPIO6 */

#define CONFIG_STM32_USART_RX_IO_PORT	0	/* PORTC */
#define CONFIG_STM32_USART_RX_IO_PIN	10	/* GPIO7 */
